...
using Reproduction.Models.TokenAuth;
...
{
    public abstract class ReproductionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ReproductionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ReproductionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ReproductionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ReproductionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ReproductionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ReproductionDbContext, Task<T>> func)
        {
            T result;
